...
public class MainActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String name=intent.getStringExtra("11");
        ...
        queding.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(sex.length()==0){
                    Toast.makeText(MainActivity3.this,OMG,Toast.LENGTH_SHORT).show();
                }
                else
                Toast.makeText(MainActivity3.this,info,Toast.LENGTH_SHORT).show();
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                Toast.makeText(MainActivity3.this,r.getText().toString(),Toast.LENGTH_SHORT).show();
            }
        });
